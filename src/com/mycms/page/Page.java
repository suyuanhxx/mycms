...
public class Page  implements java.io.Serializable {
	...
	/** 页码 List */
	protected List<Integer> pages = new ArrayList<Integer>();
	Object obj;   //参数对象与返回对象
	//List<Object> resultList; // 返回的结果
    Map<String,Object>  param = Maps.newHashMap();      //查询入参	
	...
	public void setPagedView(String path) {
		...
		sb.append("文档总数: " + totalRows + ", 共" + totalPage + "页, 第"
				+ currentPage + "页, 转到 ");
		...
		sb.append("&nbsp;&nbsp;&nbsp;&nbsp;");
		sb.append("<INPUT name=totalPage type=hidden value='" + totalPage
				+ "'>");		
		sb.append("&nbsp;&nbsp;");
		...
		sb.append("var totalPage = 0;\n");
		sb.append("totalPage = document.forms[0].totalPage.value;\n");
		sb.append("if (parseInt(page) > parseInt(totalPage) || parseInt(page) <1) {page =1;}\n");
	...
	public void setPagedView() {
		...
		if (hasNextPage) {
			...
			sb.append("&nbsp;&nbsp;");
			sb.append("<input type='button' value='末页' class='button' onclick='search_pagedForm(" 
					+ totalPage + ");return false;' disabled='disabled'>");
			//sb.append("<IMG title='下一页' src='../../images/2.gif' border=0>");
			//sb.append("&nbsp;&nbsp;");
			//sb.append("<IMG title='最末页' src='../../images/3.gif' border=0>");
		}
		...
		sb.append("var totalPage = 0;\n");
		sb.append("totalPage = document.forms[0].totalPage.value;\n");
		sb.append("if (parseInt(page) > parseInt(totalPage) ) {document.pagedForm.page.value =totalPage;}\n");
